            ...
            <div class="container">
                <div class="facility-content">
                    <div class="facility-info" id="1">
                        <div class="info">
                            <div class="number">رقم المبنى : 1</div>
                            <div class="name">اسم المبنى : عمادة شؤون الطلاب / النادي الرياضي</div>
                            <div class="location">
                                <a href="https://goo.gl/maps/V96AMJAzYq5E3BgZ9">مكان المبنى :https://googlemap.com</a>
                            </div>
                            <div class="working-hours">
                                اوقات العمل: 8:00 صباحاً - 7:00 مساء <br>
                                <script>
                            ...
                            <div class="other-info">
                                معلومات اضافية : يتم اصدار البطاقة الجامعية هنا، كما يوجد نادي رياضي لجميع المنسوبين    
                            </div>
                        </div>
                    ...
                    <div class="facility-info" id="2">
                        <div class="info">
                            <div class="number">رقم المبنى : 2</div>
                            <div class="name">اسم المبنى : القاعة الكبرى</div>
                            <div class="location">
                                <a href="https://maps.app.goo.gl/pK8NyBGHinMAfPfm9?g_st=iw">مكان المبنى :https://googlemap.com</a>
                            </div>
                            <div class="working-hours">
                                اوقات العمل: 8:00 صباحاً - 1:00 ظهراً <br>
                                <script>
                                    document.write("حالة العمل: ");
                            ...
                            <div class="other-info">
                                معلومات اضافية : ويكون فيها استضافة العديد من الاحداث مثل المؤتمرات، استعراض مشاريع التخرج وغيرها    
                            </div>
                        </div>
                    ...
                    <div class="facility-info" id="3">
                        <div class="info">
                            <div class="number">رقم المبنى : 3</div>
                            <div class="name">اسم المبنى : القاعة الصغرى</div>
                            <div class="location">
                            ...
                            <div class="other-info">
                                معلومات اضافية : يتم استضافة بعض الانشطة والدورات فيها
                            </div>
                        </div>
                    ...
                    <div class="facility-info" id="4">
                        <div class="info">
                            <div class="number">رقم المبنى : 4</div>
                            <div class="name">اسم المبنى : ادارة الجامعة</div>
                            <div class="location">
                            ...
                            <div class="other-info">
                                معلومات اضافية : يتضمن مكتب رئيس الجامعة والادارة العليا بالجامعة    
                            </div>
                        </div>
                    ...
                    <div class="facility-info" id="5">
                        <div class="info">
                            <div class="number">رقم المبنى : 5</div>
                            <div class="name">اسم المبنى : قاعات ومكاتب هئية التدريس</div>
                            <div class="location">
                            ...
                            <div class="other-info">
                                معلومات اضافية : وفيه تتم الاختبارات الورقية المقدمة من المركز الوطني للقياس مثل اختبار القدرات العامة، واختبار التحصيل الدراسي    
                            </div>
                        </div>
                    ...
                    <div class="facility-info" id="6">
                        <div class="info">
                            <div class="number">رقم المبنى : 6</div>
                            <div class="name">اسم المبنى : المسبح</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="7">
                        <div class="info">
                            <div class="number">رقم المبنى : 7</div>
                            <div class="name">اسم المبنى : مستودع التشغيل والصيانة</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="8">
                        <div class="info">
                            <div class="number">رقم المبنى : 8</div>
                            <div class="name">اسم المبنى : المكتبة المركزية</div>
                            <div class="location">
                            ...
                            <div class="other-info">
                                معلومات اضافية : وفيها العديد من الخدمات لمنسوبي الجامعة مثل حجز بعض الغرفة المغلقة للدراسة او الاجتماعات
                            </div>
                        </div>
                    ...
                    <div class="facility-info" id="9">
                        <div class="info">
                            <div class="number">رقم المبنى : 9</div>
                            <div class="name">اسم المبنى : كلية الهندسة - للمعلمات</div>
                            <div class="location">
                            ...
                            <div class="other-info">
                                معلومات اضافية : وفيها بعض المكاتب للمعلمات في كلية الهندسة
                            </div>
                        </div>
                    ...
                    <div class="facility-info" id="10">
                        <div class="info">
                            <div class="number">رقم المبنى : 10</div>
                            <div class="name">اسم المبنى : المسجد</div>
                            <div class="location">
                            ...
                            <div class="other-info">
                                معلومات اضافية : يعتبر المسجد المصغر فالجامعة
                            </div>
                        </div>
                    ...
                    <div class="facility-info" id="11">
                        <div class="info">
                            <div class="number">رقم المبنى : 11</div>
                            <div class="name">اسم المبنى : قسم الهندسة الصناعية</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="12">
                        <div class="info">
                            <div class="number">رقم المبنى : 12</div>
                            <div class="name">اسم المبنى : ادارة الامن الجامعي</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="13">
                        <div class="info">
                            <div class="number">رقم المبنى : 13</div>
                            <div class="name">اسم المبنى : قسم الهندسة الميكانيكية</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="14">
                        <div class="info">
                            <div class="number">رقم المبنى : 14</div>
                            <div class="name">اسم المبنى : معامل كلية الهندسة</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="15">
                        <div class="info">
                            <div class="number">رقم المبنى : 15</div>
                            <div class="name">اسم المبنى : معامل كلية الهندسة</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="16">
                        <div class="info">
                            <div class="number">رقم المبنى : 16</div>
                            <div class="name">اسم المبنى : معامل كلية الهندسة</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="17">
                        <div class="info">
                            <div class="number">رقم المبنى : 17</div>
                            <div class="name">اسم المبنى : معامل كلية الهندسة</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="18">
                        <div class="info">
                            <div class="number">رقم المبنى : 18</div>
                            <div class="name">اسم المبنى : معامل كلية الهندسة</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="19">
                        <div class="info">
                            <div class="number">رقم المبنى : 19</div>
                            <div class="name">اسم المبنى : مركز البحوث والاستشارات</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="20">
                        <div class="info">
                            <div class="number">رقم المبنى : 20</div>
                            <div class="name">اسم المبنى : ادارة الشبكة الهاتفية والاعلام </div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="21">
                        <div class="info">
                            <div class="number">رقم المبنى : 21</div>
                            <div class="name">اسم المبنى : ادارة الصيانة والتشغيل / الدعم الاكاديمي</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="22">
                        <div class="info">
                            ...
                            <div class="name">
                                اسم المبنى : قاعات ومكاتب ومعامل كلية الهندسة
                            </div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="23">
                        <div class="info">
                            <div class="number">رقم المبنى : 23</div>
                            <div class="name">اسم المبنى : معمل الهندسة المدنية</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="24">
                        <div class="info">
                            <div class="number">رقم المبنى : 24</div>
                            <div class="name">اسم المبنى : كلية المجتمع</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="25">
                        <div class="info">
                            <div class="number">رقم المبنى : 25</div>
                            <div class="name">اسم المبنى : عمادة القبول والتسجيل</div>
                            <div class="location">
                            ...
                            <div class="other-info">
                                معلومات اضافية : تعتبر عمادة القبول هي المسؤولة عن تسجيل المستجدين في الجامعة او التحويل بين التخصصات
                            </div>
                        </div>
                    ...
                    <div class="facility-info" id="26">
                        <div class="info">
                            <div class="number">رقم المبنى : 26</div>
                            <div class="name">اسم المبنى : عمادة تقنية المعلومات</div>
                            <div class="location">
                            ...
                            <div class="other-info">
                                معلومات اضافية : وتعتبر مسؤولة عن الخدمات الالكترونية داخل الجامعة مثل الايميل الجامعي، وشبكة الانترنت داخل الحرم الجامعي
                            </div>
                        </div>
                    ...
                    <div class="facility-info" id="27">
                        <div class="info">
                            <div class="number">رقم المبنى : 27</div>
                            <div class="name">اسم المبنى : عمادة الدراسات المساندة</div>
                            <div class="location">
                            ...
                            <div class="other-info">
                                معلومات اضافية : وفيها عمادة خدمة المجتمع والتنمية المستدامة، ومركز الابتكار وريادة الاعمال
                            </div>
                        </div>
                    ...
                    <div class="facility-info" id="28">
                        <div class="info">
                            <div class="number">رقم المبنى : 28</div>
                            <div class="name">اسم المبنى : الادارات المساندة</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="29">
                        <div class="info">
                            <div class="number">رقم المبنى : 29</div>
                            <div class="name">اسم المبنى : قاعات دراسية</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="30">
                        <div class="info">
                            <div class="number">رقم المبنى : 30</div>
                            <div class="name">اسم المبنى : ادارة المشاريع والصيانة</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="31">
                        <div class="info">
                            <div class="number">رقم المبنى : 31</div>
                            <div class="name">اسم المبنى : كلية الشريعة والانظمة</div>
                            <div class="location">
                            ...
                            <div class="other-info">
                                معلومات اضافية : وفيها مكاتب اعضاء هئية التدريس في كلية الشريعة
                            </div>
                        </div>
                    ...
                    <div class="facility-info" id="32">
                        <div class="info">
                            <div class="number">رقم المبنى : 32</div>
                            <div class="name">اسم المبنى : كلية ادارة الاعمال</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="33">
                        <div class="info">
                            <div class="number">رقم المبنى : 33</div>
                            <div class="name">اسم المبنى : المطعم الجامعي</div>
                            <div class="location">
                                <a href="https://maps.app.goo.gl/W8KcN5EPBc81RD5X9?g_st=iw">مكان المبنى :https://googlemap.com</a>
                            </div>
                            <div class="working-hours">
                                اوقات العمل≈ 8:00 صباحاً - 11:30 ظهراً <br>
                                 بعد صلاة الظهر - 3:00 عصراً <br>
                                <script>
                                    document.write("حالة العمل: ");
                                    if (hours >= 13 && hours <= 23 || hours == 0) {
                                        document.write("<font color=\"red\">"+ finished +"</font>");
                            ...
                            <div class="other-info">
                                معلومات اضافية : يتوفر فيه وجبات الفطور الى قبل اذان الظهر ب 30 دقيقة، ووجبات الغداء بعد صلاة الظهر
                            </div>
                        </div>
                    ...
                    <div class="facility-info" id="34">
                        <div class="info">
                            <div class="number">رقم المبنى : 34</div>
                            <div class="name">اسم المبنى : الجامع الكبير</div>
                            <div class="location">
                            ...
                            <div class="other-info">
                                معلومات اضافية : يعتبر المسجد الرئيسي فالجامعة
                            </div>
                        </div>
                    ...
                    <div class="facility-info" id="35">
                        <div class="info">
                            <div class="number">رقم المبنى : 35</div>
                            <div class="name">اسم المبنى : قاعات دراسية ومكاتب</div>
                            <div class="location">
                            ...
                            <div class="other-info">
                                معلومات اضافية : فيه مكاتب لبعض معلمين كلية العلوم مثل قسم الرياضيات، كما يوجد قرطاسية فالدور الثاني
                            </div>
                        </div>
                    ...
                    <div class="facility-info" id="36">
                        <div class="info">
                            <div class="number">رقم المبنى : 36</div>
                            <div class="name">اسم المبنى : مبنى وكالات الجامعة</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="37">
                        <div class="info">
                            <div class="number">رقم المبنى : 37</div>
                            <div class="name">اسم المبنى : كلية العلوم</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="38">
                        <div class="info">
                            <div class="number">رقم المبنى : 38</div>
                            <div class="name">اسم المبنى : معامل كلية العلوم</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="39">
                        <div class="info">
                            <div class="number">رقم المبنى : 39</div>
                            <div class="name">اسم المبنى : معامل كلية العلوم</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="40">
                        <div class="info">
                            <div class="number">رقم المبنى : 40</div>
                            <div class="name">اسم المبنى : مبنى العمادات المساندة</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="41">
                        <div class="info">
                            <div class="number">رقم المبنى : 41</div>
                            <div class="name">اسم المبنى : الادارة الطبية</div>
                            <div class="location">
                                <a href="https://maps.app.goo.gl/oRTFBuAfEMZxtGyr6?g_st=iw">مكان المبنى :https://googlemap.com</a>
                            </div>
                            <div class="working-hours">
                                اوقات العمل: 8:00 صباحاً - 1:00 ظهرا <br>
                                <script>
                                    document.write("حالة العمل: ");
                                    if (hours >= 13 && hours <= 23 || hours == 0) {
                                        document.write("<font color=\"red\">"+ finished +"</font>");
                            ...
                            <div class="other-info">
                                معلومات اضافية : يعتبر المستوصف او المشفى داخل الجامعة لجميع المنسوبين
                            </div>
                        </div>
                    ...
                    <div class="facility-info" id="42">
                        <div class="info">
                            <div class="number">رقم المبنى : 42</div>
                            <div class="name">اسم المبنى : كلية الحاسبات وتقنية المعلومات</div>
                            <div class="location">
                            ...
                            <div class="other-info">
                                معلومات اضافية : فيها جميع مكاتب اعضاء هيئة التدريس في كلية الحاسبات بجميع اقسامها
                            </div>
                        </div>
                    ...
                    <div class="facility-info" id="43">
                        <div class="info">
                            <div class="number">رقم المبنى : 43</div>
                            <div class="name">اسم المبنى : المعشبة</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="44">
                        <div class="info">
                            <div class="number">رقم المبنى : 44</div>
                            <div class="name">اسم المبنى : مبنى اصدار تصاريح الدخول</div>
                            <div class="location">
                                <a href="https://maps.app.goo.gl/efXebCJAsjGjE8k97?g_st=iw">مكان المبنى :https://googlemap.com</a>
                            </div>
                            <div class="working-hours">
                                اوقات العمل: 8:00 صباحاً - 3:00 ظهراً <br>
                                <script>
                                    document.write("حالة العمل: ");
                            ...
                            <div class="other-info">
                                معلومات اضافية : يتم من خلاله اصدار التصاريح للدخول داخل الجامعة بالسيارة للمتفوقين وذوي الاحتياجات الخاصة
                            </div>
                        </div>
                    ...
                    <div class="facility-info" id="45">
                        <div class="info">
                            <div class="number">رقم المبنى : 45</div>
                            <div class="name">اسم المبنى : عمادة البحث العلمي</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="46">
                        <div class="info">
                            <div class="number">رقم المبنى : 46</div>
                            <div class="name">اسم المبنى : معامل كلية الحاسبات وتقنية المعلومات</div>
                            <div class="location">
                                <a href="https://maps.app.goo.gl/caTWxsZGHiDshBeH9?g_st=iw">مكان المبنى :https://googlemap.com</a>
                            </div>
                            <div class="working-hours">
                                اوقات العمل: 8:00 صباحاً - 6:00 المغرب <br>
                                <script>
                                    document.write("حالة العمل: ");
                            ...
                            <div class="other-info">
                                معلومات اضافية : يكون فيها بعض الاختبارات الحضورية في البلاك بورد
                            </div>
                        </div>
                    ...
                    <div class="facility-info" id="47">
                        <div class="info">
                            <div class="number">رقم المبنى: 47</div>
                            <div class="name">اسم المبنى : ادارة المستودعات</div>
                            <div class="location">
                    ...
                    <div class="facility-info" id="48">
                        <div class="info">
                            <div class="number">رقم المبنى : 48</div>
                            <div class="name">اسم المبنى : المجهر الالكتروني</div>
                            <div class="location">
